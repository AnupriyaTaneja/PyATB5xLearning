...
def test_negative_app_vwo_com():
    ...
    # driver.implicitly_wait(5) #webdriver will wait for 5secs before interacting with below web elements
# implicit wait is never going to be used in automation framework as implicit wait gets applied to all web elements.
# Explicit wait will be used.
